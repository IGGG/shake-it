iopctrl = function() {
    ...
    iopctrl.led = function() {
        var width = 20, height = 10, round = 2, on = true, colorOn = d3.rgb("#000000"), colorOff = colorOn.darker(2), transitionDuration = 100;
        var _ledUpdate;
    ...
    iopctrl.ledarray = function() {
        ...
        var thresholds = d3.scale.threshold()
            .domain([0.05, 0.10, 0.15, 0.20, 0.25, 0.30, 0.35, 0.40, 0.45, 0.50, 0.55, 0.60, 0.65, 0.70, 0.75, 0.80, 0.85, 0.90, 0,95, 1.00])
            .range(["#B50157", "#B60551", "#B60749", "#B50B3C", "#B40C3C", "#B40D38", "#B40E37", "#B30D39", "#B30C3E", "#A91042", "#961646","#841A4B","#741C54", "#701C56" ,"#6A1B5E", "#651967", "#60186C", "#581A6D" ,"#531B6D", "#511B6D"]);
